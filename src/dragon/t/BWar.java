...
public class BWar {
    ...
    public BWar(int bId, String name, int timeDelay, ZoneMap zone) {
    ...
    public static void addBWar(int bId, String name, int timeDelay, ZoneMap zone) {
        BWar b = new BWar(bId, name, timeDelay, zone);
        add(b);
    }
    ...
    //                                    Map map = Map.getMapServer(0);
                        ...
                        if (bWar.bId == 3) {
                            kiemtra:
                            {
                                if (bWar.tick == 0) {
                                    //Cadic
                                    bWar.ARRPLAYER.add(Player.addBoss(85, 0, -1, -1, true, 480, 336, bWar.zone, -1, -1));
                                    bWar.ARRPLAYER.get(0).bWar = bWar;
                                    bWar.ARRPLAYER.get(0).timeClear = 60000;
                                    bWar.ARRPLAYER.get(0).changeFlag(Flag.get(520).id);
                                    //Goku
                                    bWar.ARRPLAYER.add(Player.addBoss(84, 0, -1, -1, true, 490, 336, bWar.zone, -1, -1));
                                    bWar.ARRPLAYER.get(1).bWar = bWar;
                                    ...
                                    Player boss = Player.addBoss(81, 0, -1, -1, true, 290, 336, bWar.zone, 5000, -1);
                                    boss.isArgue = true;
                                    boss.setLive(60);
                                    bWar.removeAtTheEnd = true;
                                }
