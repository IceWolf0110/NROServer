...
public class ServerActivity {
    ...
    private final String NAME = "Hệ thống Dragon";
        ...
        public void run() {
            while(isStart) {
                ...
                if (Server.gI().timeBaoTri != -1) {
                    ...
                    ServerActivity.gI().getButton(14).setText("Bật bảo trì sau 30p");
                }
                try {
